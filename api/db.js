...
export function initDB() {
  ...
  const DATA_VERSION = 3; // increment this when seed data changes
  db.exec(`CREATE TABLE IF NOT EXISTS _meta (key TEXT PRIMARY KEY, value TEXT)`);
  const ver = db.prepare(`SELECT value FROM _meta WHERE key='data_version'`).get();
  if (!ver || parseInt(ver.value) < DATA_VERSION) {
    db.exec(`DELETE FROM regulatory_updates; DELETE FROM country_regulations; DELETE FROM substances`);
    seedData(db);
    db.prepare(`INSERT OR REPLACE INTO _meta (key,value) VALUES ('data_version',?)`).run(String(DATA_VERSION));
  }
...
function seedData(db) {
  ...
  const updates = [
    ...
    // 2025 updates
    ['China GB 2760-2024 Takes Effect: Key Changes for Industry', '中国GB 2760-2024正式实施，行业重要变化解读', 'China\'s updated food additive standard GB 2760-2024 officially took effect on February 8, 2025. Key changes include: 13 new food additives approved (including several enzyme preparations), expanded permitted uses for existing additives such as xanthan gum and carrageenan, and stricter limits on several synthetic colorants. Food businesses must ensure compliance.', 'https://www.nhc.gov.cn/sps/', '国家卫生健康委员会', 'china', 'CN', 'general', '["Xanthan Gum","Carrageenan","Tartrazine"]', 'new_regulation', '2025-02-08', '2025-02-08', 'zh', 0.99],
    ['EU Commission Publishes Revised Annex II on Permitted Food Additives', '欧盟委员会发布修订版食品添加剂许可附录II', 'The European Commission published Regulation (EU) 2025/312 amending Annex II to Regulation (EC) No 1333/2008 regarding permitted food additives. The revision updates maximum levels for several emulsifiers and stabilisers in dairy alternatives and plant-based products, reflecting growing market demand for these categories.', 'https://eur-lex.europa.eu/', 'EUR-Lex', 'eu', 'EU', 'emulsifiers', '["Carrageenan","Lecithin"]', 'amendment', '2025-03-15', '2025-03-15', 'en', 0.95],
    ['FDA Finalizes Rule Banning Red Dye No. 3 (Erythrosine) in Food', 'FDA最终规定禁止在食品中使用红色3号（赤藓红）', 'The U.S. Food and Drug Administration finalized its rule revoking the authorization for erythrosine (Red No. 3) in ingested food. The ban stems from a 1990 Delaney Clause finding that the dye causes cancer in male rats at high doses. Manufacturers had until January 2027 to reformulate. This affects maraschino cherries, cocktail cherries, and certain processed foods.', 'https://www.fda.gov/food/food-additives-petitions/color-additives', 'FDA', 'usa', 'US', 'colorants', '[]', 'ban', '2027-01-15', '2025-01-15', 'en', 0.98],
    ['EFSA Publishes Updated Opinion on Carrageenan (E407) Safety', 'EFSA发布更新版卡拉胶(E407)安全意见', 'EFSA\'s Panel on Food Additives and Flavourings (FAF) published an updated scientific opinion on carrageenan (E407) and processed Eucheuma seaweed (E407a). The panel concluded that the current acceptable daily intake (ADI) of "not specified" remains appropriate for adults but recommended further studies on infant exposure. No immediate regulatory change is required.', 'https://www.efsa.europa.eu/', 'EFSA', 'eu', 'EU', 'emulsifiers', '["Carrageenan"]', 'safety_assessment', null, '2025-04-10', 'en', 0.93],
    ['Indonesia BPOM Issues New Regulation on Sweeteners in Beverages', '印尼BPOM发布饮料中甜味剂新法规', 'BPOM Indonesia issued Regulation No. 11/2025 establishing new maximum permitted levels for intense sweeteners in non-alcoholic beverages. Aspartame is capped at 600 mg/L, acesulfame K at 350 mg/L, and stevia glycosides at 200 mg/L. The regulation aims to align Indonesia with ASEAN harmonized standards.', 'https://www.pom.go.id/', 'BPOM Indonesia', 'sea', 'ID', 'sweeteners', '["Aspartame","Acesulfame K","Stevia Glycosides"]', 'new_regulation', '2025-07-01', '2025-03-20', 'en', 0.91],
    ['China NHSA Approves Lacticaseibacillus paracasei as New Food Raw Material', '中国卫健委批准副干酪乳酪杆菌为新食品原料', '国家卫生健康委员会发布公告，批准副干酪乳酪杆菌（Lacticaseibacillus paracasei）等3种益生菌作为新食品原料，可用于乳制品、饮料、保健食品等。每日推荐摄入量不超过1×10¹⁰ CFU。这是2025年上半年批准的第二批新食品原料。', 'https://www.nhc.gov.cn/', '国家卫生健康委员会', 'china', 'CN', 'functional_ingredients', '[]', 'approval', '2025-04-01', '2025-04-01', 'zh', 0.94],
    ['UAE ESMA Updates Food Colorant Standards Aligned with Codex 2025', '阿联酋ESMA更新食品色素标准与国际食品法典2025版对齐', 'Emirates Authority for Standardization and Metrology (ESMA) published updated UAE.S 37:2025 for food colorants, replacing the 2020 edition. The revised standard aligns with Codex Alimentarius GSFA updates from 2024-2025 and introduces new provisions for natural colorants including spirulina extract and beta-carotene from algae sources.', 'https://www.esma.gov.ae/', 'ESMA UAE', 'mea', 'AE', 'colorants', '["Beta-Carotene"]', 'new_regulation', '2025-06-01', '2025-05-05', 'en', 0.90],
    ['EU EFSA Re-evaluates Sunset Yellow (E110): ADI Lowered', '欧盟EFSA重新评估日落黄(E110)：每日允许摄入量下调', 'EFSA\'s FAF Panel completed its re-evaluation of sunset yellow FCF (E110) and concluded that the acceptable daily intake (ADI) should be lowered from 4 mg/kg bw/day to 2.5 mg/kg bw/day based on updated toxicological data. The Commission is expected to propose amendments to permitted levels in certain food categories within 12 months.', 'https://www.efsa.europa.eu/', 'EFSA', 'eu', 'EU', 'colorants', '["Sunset Yellow FCF"]', 'safety_assessment', null, '2025-02-28', 'en', 0.96],
    ['Malaysia MOH Publishes Updated Food Regulations 1985 (Amendment 2025)', '马来西亚卫生部发布1985年食品法规2025年修订版', 'The Malaysian Ministry of Health gazetted the Food Regulations 1985 (Amendment) 2025, which introduces new provisions for food additives in plant-based and functional food categories. The amendment adds 12 new permitted additives and revises maximum levels for 8 existing ones, including sodium benzoate in certain fermented products.', 'https://www.moh.gov.my/', 'Malaysian Ministry of Health', 'sea', 'MY', 'general', '["Sodium Benzoate"]', 'amendment', '2025-05-01', '2025-04-15', 'en', 0.89],
    ['US FDA Proposes Revoking Authorization for Several Synthetic Dyes', 'FDA提议撤销多种合成色素授权', 'Following growing public pressure and state-level bans (California\'s Food Safety Act), the FDA has proposed revoking authorizations for FD&C Red No. 40 (Allura Red), Yellow No. 5 (Tartrazine), and Yellow No. 6 (Sunset Yellow) in certain food categories, particularly products marketed to children. A public comment period of 90 days has been opened.', 'https://www.fda.gov/', 'FDA', 'usa', 'US', 'colorants', '["Allura Red AC","Tartrazine","Sunset Yellow FCF"]', 'consultation', null, '2025-03-10', 'en', 0.97],
    ['Codex Alimentarius Commission Adopts New GSFA Amendments at CAC47', '国际食品法典委员会第47届会议通过GSFA新修订', 'The Codex Alimentarius Commission at its 47th session (CAC47, Geneva, 2025) adopted amendments to the General Standard for Food Additives (GSFA). Key adoptions include new provisions for steviol glycosides in additional food categories, revised limits for phosphoric acid in cola-type beverages, and new listings for several enzyme preparations used in food processing.', 'https://www.fao.org/fao-who-codexalimentarius/', 'Codex Alimentarius Commission', 'global', 'CODEX', 'general', '["Stevia Glycosides","Phosphoric Acid"]', 'new_regulation', '2025-07-15', '2025-05-20', 'en', 0.96],

    // 2026 updates
    ['China NHSA Releases Draft Amendment to GB 2760 for Public Comment', '中国卫健委发布GB 2760修订草案征求意见', '国家卫生健康委员会就《食品安全国家标准 食品添加剂使用标准》(GB 2760)修订草案向社会公开征求意见，征求意见截止日期为2026年3月31日。草案拟新增天然色素叶黄素酯、辣椒橙等的使用规定，并拟调整部分合成色素的最大使用量，公众可通过官网提交意见。', 'https://www.nhc.gov.cn/', '国家卫生健康委员会', 'china', 'CN', 'general', '[]', 'consultation', null, '2026-02-15', 'zh', 0.97],
    ['EU Formally Adopts Regulation Lowering Sunset Yellow (E110) Limits', '欧盟正式通过降低日落黄(E110)限量的法规', 'Following EFSA\'s 2025 re-evaluation, the European Commission published Regulation (EU) 2026/88 formally reducing maximum permitted levels of sunset yellow FCF (E110) across multiple food categories. Beverages limits drop from 50 mg/L to 30 mg/L. Manufacturers have an 18-month transition period to reformulate products.', 'https://eur-lex.europa.eu/', 'EUR-Lex', 'eu', 'EU', 'colorants', '["Sunset Yellow FCF"]', 'amendment', '2027-10-01', '2026-03-01', 'en', 0.95],
    ['FDA Announces Phase-out Timeline for Remaining Synthetic Dyes', 'FDA宣布剩余合成色素淘汰时间表', 'Following the finalization of the Red No. 3 ban and ongoing review of other synthetic dyes, the FDA announced a phased timeline to transition the U.S. food supply away from petroleum-derived synthetic color additives by 2030. The agency will work with industry to identify natural color alternatives and update approval pathways for novel natural colorants.', 'https://www.fda.gov/', 'FDA', 'usa', 'US', 'colorants', '["Allura Red AC","Tartrazine","Sunset Yellow FCF","Brilliant Blue FCF"]', 'guidance', '2030-12-31', '2026-04-22', 'en', 0.98],
    ['Singapore SFA Approves New Natural Colorants Including Gardenia Blue', '新加坡SFA批准多种天然色素包括栀子蓝', 'The Singapore Food Agency has approved several new natural colorants for use in food products: gardenia blue (from Gardenia jasminoides), butterfly pea flower extract, and red radish extract. The approvals respond to industry demand for synthetic dye alternatives following regulatory pressure in EU and US markets.', 'https://www.sfa.gov.sg/', 'Singapore Food Agency', 'sea', 'SG', 'colorants', '[]', 'approval', '2026-06-01', '2026-03-18', 'en', 0.92],
    ['China Issues New Standard for Food Enzyme Preparations (GB 25594 Revision)', '中国发布食品用酶制剂新国家标准(GB 25594修订)', '国家市场监督管理总局发布《食品安全国家标准 食品用酶制剂》(GB 25594)修订版，新增批准14种食品酶制剂，包括葡萄糖氧化酶、木聚糖酶等，同时规定了酶制剂的质量规格要求和标识规范。新标准于2026年6月1日起施行。', 'https://www.nhc.gov.cn/', '国家卫生健康委员会', 'china', 'CN', 'general', '[]', 'new_regulation', '2026-06-01', '2026-04-10', 'zh', 0.93],
    ['EFSA Completes Re-evaluation of Tartrazine (E102): ADI Confirmed', 'EFSA完成柠檬黄(E102)重新评估：ADI值维持不变', 'EFSA\'s Food Additives and Flavourings Panel completed its scheduled re-evaluation of tartrazine (E102). The panel confirmed the existing ADI of 7.5 mg/kg bw/day remains appropriate. However, the panel noted that exposure among high consumers, particularly children, may approach or exceed the ADI in some scenarios, and recommended food businesses consider voluntary reformulation.', 'https://www.efsa.europa.eu/', 'EFSA', 'eu', 'EU', 'colorants', '["Tartrazine"]', 'safety_assessment', null, '2026-05-08', 'en', 0.96],
    ['Thailand FDA Updates Permitted Food Additives List 2026', '泰国FDA更新2026年食品添加剂许可名单', 'Thailand\'s Food and Drug Administration published the updated Notification of the Ministry of Public Health on food additives, effective May 2026. The update adds 9 new permitted additives, including two new steviol glycoside variants (Reb M and Reb D) at up to 100 mg/kg in beverages, and aligns limits for several preservatives with Codex standards.', 'https://www.fda.moph.go.th/', 'Thailand FDA', 'sea', 'TH', 'sweeteners', '["Stevia Glycosides"]', 'new_regulation', '2026-05-01', '2026-04-25', 'en', 0.90],
  ];
